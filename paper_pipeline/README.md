...
6. `06_fit_models_and_predict.py`  
   Fit logistic models (CAPRA / Clinical / ImageModel / Habitat / Clin+Img / Combined) and export predicted probabilities.

7. `07_evaluate_models_and_plot_roc.R`  
   Evaluate model performance (AUC, Brier, calibration, Youden-based sensitivity/specificity) and generate ROC plots.
